             ...
             <% 
            	...
            	<div class="calendar_box2">
                	...
                	<div class="calendar_box_content">
                		...
                		<form method="post" action=Get0 style="background_color: white;">
					<table>
					<tr>
			<td>Enter the subject:</td><td><input type="text" name="subject" /></td>
			</tr>
			<tr>
			<td></td><td><input type="submit" value="start"></td>
			</tr>
			</table>
					<div id="location" ></div>
                     </form>
